...
REM Debug
REM cl -nologo -MD -Zi -FC -WX -W4 %warnings_to_ignore% ..\src\*.c ..\src\resource.res /DUNICODE /D_UNICODE /link user32.lib gdi32.lib comctl32.lib /out:minesweeper_debug.exe 

REM Prod
cl -nologo -O2 -MD ..\src\*.c ..\src\resource.res /DUNICODE /D_UNICODE /link user32.lib gdi32.lib comctl32.lib /out:minesweeper.exe
