...
REM Debug
cl -nologo -Zi -FC -WX -Wall %warnings_to_ignore%  ..\src\main.c ..\src\resource.res /link user32.lib gdi32.lib comctl32.lib /out:minesweeper_cx.exe

REM Prod
REM cl -nologo -O2 -FC -WX -Wall %warnings_to_ignore% ..\src\main.c ..\src\resource.res /link user32.lib gdi32.lib comctl32.lib /out:minesweeper_cx.exe
