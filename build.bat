...
REM Debug
cl -nologo -Zi -FC -WX -W4 %warnings_to_ignore% ..\src\*.c ..\src\resource.res /DUNICODE /D_UNICODE /link user32.lib gdi32.lib comctl32.lib /out:minesweeper_cx.exe 

REM Prod
REM cl -nologo -O2 -FC -WX -Wall %warnings_to_ignore% ..\src\*.c ..\src\resource.res /DUNICODE /D_UNICODE /link user32.lib gdi32.lib comctl32.lib /out:minesweeper_cx.exe
